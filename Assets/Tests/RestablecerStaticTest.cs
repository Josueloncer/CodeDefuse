...
public class RestablecerStaticTest {
    ...
    public void RestablecerStaticTestSimplePasses()
    {
        ...
        LogicaVer4.Numero_De_Focos_Prendidos = 5;
        LogicaVer4.Jugando = false;
        LogicaVer4.Tiempo_De_Espera_Despues_Del_Tap = 0f;
        LogicaVer4.Tap_Del_Jugador = 7;

        LogicaJ1.Numero_De_Focos_Prendidos = 5;
        LogicaJ1.Jugando = false;
        LogicaJ1.TiempoDeEsperaParaRegrezarAMenu = 5;
        LogicaJ1.Tiempo_De_Espera_Despues_Del_Tap_1 = 5f;
        LogicaJ1.Tap_Del_Jugador_1 = 5;
        LogicaJ1.J1Gano = 5;

        LogicaJ2.Numero_De_Focos_Prendidos = 5;
        LogicaJ2.Jugando = false;
        LogicaJ2.TiempoDeEsperaParaRegrezarAMenu = 5;
